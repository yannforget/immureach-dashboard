...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-8 px-3 py-2 text-left align-middle text-xs font-semibold text-slate-700 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('px-3 py-1.5 text-sm align-middle [&:has([role=checkbox])]:pr-0', className)}
    {...props}
  />
))
